package Project;
	...
	public class Activity2 {
		...
		public void googleKeepTest() {
			...
			driver.findElement(AppiumBy.id("com.google.android.keep:id/editable_title")).sendKeys("sireesha");
			driver.findElement(AppiumBy.id("com.google.android.keep:id/edit_note_text")).sendKeys("sireesha dodla");
